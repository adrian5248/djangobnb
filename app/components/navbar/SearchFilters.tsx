const SearchFilters = () => {
    return(
        <div className="h-[48px] lg:[64] flex flex-row items-center justify-between border rounded-full">
                ...
                <div className="flex flex-row items-center justify-between">
                    ...
                    <div className="p-2">
                        ...
                        <svg 
                            ...
                            display:'block', fill:'none', height:'16px',
                            width: '16px', stroke: 'currentColor', strokeWidth:4,
                            overflow:'visible'
                            }}
